**AI Score / AIs 기획 문서 안내**

현재 기준은 [통합 기획서 v0.6 — AI·SaaS 정보 탐색과 개인 활용](/Users/bigmac_moon/dev/ai_score/docs/2026-09-12-product-plan-v0.6.md)이다.

2026-09-12 사용자 지시에 따라 AI·SaaS 정보·평가·추천·활용법·뉴스·업데이트·행사·커뮤니티는 개인 관리와 최소 동등한 비중을 갖는다. 기본 홈은 공개 정보 탐색이며, 개인 페이지는 고객별 도구·구독·기록을 관리하는 공간이다. 정보를 얻고 이해한 방문도 독립된 성공으로 평가한다.
...
v0.1~v0.5는 이전 논의를 보존한 문서다. 전체 방향이나 출시 우선순위가 충돌하면 v0.6을 우선한다. 개별 기능의 상세 문서가 길다는 이유로 해당 기능을 전체 서비스의 중심으로 해석하지 않는다. 실제 구현 완료 여부는 기획 문서와 별도로 확인한다.
