...
const site='/Users/bigmac_moon/dev/ai_score/site',tmp='/private/tmp',prefix='ais-v11-relevance-final-regression-2';
...
const protectedFiles=['ais-v10-purpose-query-cases.json','ais-v10-purpose-query-runner.cjs','ais-v11-relevance-holdout-cases.json','ais-v11-relevance-initial-observations.json','ais-v11-relevance-initial-observations.md','ais-v11-relevance-final-regression.json','ais-v11-relevance-final-regression.md'];
