...
export const tools: Tool[] = [
  ...
  {
    id: "a04e1cdd-db45-486d-a459-fa4d419f1719",
    name: "Higgsfield",
    description: "Sora 2·Veo 3.1·Kling 등 여러 영상 모델을 한곳에서 쓰는 시네마틱 제작 도구입니다.",
    problemContexts: ["브랜드 광고 외주비가 부담된다", "여러 영상 AI를 각각 구독하기 번거롭다", "실사 촬영 없이 카메라 연출이 필요하다"],
    whyExist: "Sora 2, Veo 3.1, Kling 3.0 등 영상 생성 모델이 난립하면서 매번 비교·구독하는 비용과 수고를 없애기 위해, 여러 모델을 한 크레딧 체계로 묶은 아그리게이터형 플랫폼으로 등장했습니다.",
    impact: { judgmentSpeed: 7, thinkingDepth: 3, executionDensity: 8, collaborationClarity: 4 },
    bestCase: "여러 모델을 동시에 비교하며 예산 안에서 광고 시안을 빠르게 여러 개 뽑아 컨셉 검증 시간을 크게 줄일 수 있습니다.",
    worstCase: "크레딧 소진 구조를 모르고 쓰면 예산이 쉽게 초과되고, 동의 없는 인물 합성 논란처럼 브랜드 평판 리스크로 번질 수 있습니다.",
    verdictBadges: { timeSaver: true, thinkCarefully: true, lockinRisk: true },
  ...
  {
    id: "7f50d95e-6c5d-47a5-a5a6-a4369344017f",
    name: "Runway",
    description: "자체 Gen-4 계열 모델과 Aleph 편집 기능을 갖춘 AI 영상 제작·편집 플랫폼입니다.",
    problemContexts: ["실사 촬영 없이 VFX가 필요하다", "촬영본을 재촬영 없이 수정하고 싶다", "광고 클립을 빠르게 제작해야 한다"],
    whyExist: "실사 촬영과 VFX 제작에 드는 시간·비용을 줄이기 위해 자체 기반모델을 처음부터 학습시킨 영상 생성 스타트업으로 출발해, 이후 기존 영상 편집까지 아우르는 종합 플랫폼으로 확장했습니다.",
    impact: { judgmentSpeed: 7, thinkingDepth: 4, executionDensity: 8, collaborationClarity: 5 },
    bestCase: "VFX·크리에이티브 팀이 재촬영 없이 여러 컷을 빠르게 실험해 프리비주얼 시간과 외주 비용을 크게 줄일 수 있습니다.",
    worstCase: "초당 단위로 크레딧이 빨리 소모돼 예산을 초과하기 쉽고, 유튜브 학습데이터 저작권 소송처럼 법적 리스크가 브랜드로 전이될 수 있습니다.",
    verdictBadges: { timeSaver: true, thinkCarefully: true, lockinRisk: true },
    alternatives: ["Higgsfield", "Pika", "Luma AI"],
    category: "AI 영상 생성",
  ...
  {
    id: "4cb2986a-6f10-411c-a9d5-09be356f8d89",
    name: "HeyGen",
    description: "실사형 아바타와 175개 이상 언어 더빙으로 발표자 영상을 만드는 AI 아바타 플랫폼입니다.",
    problemContexts: ["설명 영상마다 촬영 인력이 필요하다", "다국어 더빙 외주가 오래 걸린다", "교육 영상 갱신 속도가 느리다"],
    whyExist: "카메라·스튜디오 없이 발표자 영상을 반복 제작해야 하는 마케팅·교육 조직의 수요와 다국어 더빙에 드는 시간·비용 문제를 해결하기 위해 아바타·립싱크 번역 기술에 특화해 등장했습니다.",
    impact: { judgmentSpeed: 7, thinkingDepth: 3, executionDensity: 8, collaborationClarity: 6 },
    bestCase: "교육·마케팅 팀이 촬영 없이 다국어 버전 영상을 동시에 만들어 현지화 속도와 콘텐츠 갱신 주기를 크게 단축할 수 있습니다.",
    worstCase: "본인 동의 없는 아바타·음성 합성이 초상권 분쟁으로 번지거나, 무제한 요금제 폐지 이후 예상보다 빠른 크레딧 소진으로 예산이 초과될 수 있습니다.",
    verdictBadges: { timeSaver: true, thinkCarefully: true, lockinRisk: true },
    alternatives: ["Synthesia", "D-ID", "Colossyan"],
    category: "AI 아바타 영상 생성",
    website: "https://www.heygen.com",
    createdAt: "2026-09-15T00:00:00Z",
    updatedAt: "2026-09-15T00:00:00Z"
  },
  {
    id: "3eb0d80f-c91b-40b9-a57b-ceb5bc76ad1c",
    name: "ElevenLabs",
    description: "텍스트를 실감나는 음성으로 바꾸고 목소리를 복제해주는 콘텐츠·비즈니스용 AI 음성 플랫폼입니다.",
    problemContexts: ["영상 나레이션 녹음이 번거롭다", "다국어 더빙 제작이 오래 걸린다", "상담 자동화 음성이 어색하다"],
    whyExist: "성우 섭외와 스튜디오 녹음 없이 고품질 음성 콘텐츠를 빠르게 만들려는 수요에서 출발했고, 유튜브·팟캐스트·게임 등 콘텐츠 산업의 다국어 더빙·상담 자동화 수요가 커지며 대화형 AI 에이전트 사업까지 확장했습니다.",
    impact: { judgmentSpeed: 8, thinkingDepth: 3, executionDensity: 8, collaborationClarity: 4 },
    bestCase: "성우 섭외 없이도 고품질 다국어 내레이션과 더빙을 신속히 제작해 콘텐츠 제작 비용과 시간을 크게 절감합니다.",
    worstCase: "본인 동의 없이 목소리가 복제되어 선거 로보콜이나 유명인 사칭에 악용되면 피해 당사자의 명예와 대중의 신뢰가 크게 훼손됩니다.",
    verdictBadges: { timeSaver: true, thinkCarefully: true, lockinRisk: true },
    alternatives: ["OpenAI TTS", "Murf", "Play.ht"],
    category: "AI 음성 / 더빙",
  ...
  {
    id: "be7a6ff5-34ca-4d4c-aec2-f42ba6f729fc",
    name: "Suno",
    description: "텍스트 프롬프트나 가사만으로 보컬이 포함된 완성곡을 만들어주는 AI 음악 생성 서비스입니다.",
    problemContexts: ["배경음악 저작권이 부담스럽다", "작곡·작사 지식이 부족하다", "짧은 영상용 음악 제작이 느리다"],
    whyExist: "전문 작곡·편곡 지식 없이도 유튜브·광고·게임에 쓸 배경음악과 완성곡을 빠르게 만들려는 수요와 생성형 음악 모델의 발전이 맞물려 등장했습니다.",
    impact: { judgmentSpeed: 8, thinkingDepth: 2, executionDensity: 7, collaborationClarity: 3 },
    bestCase: "전문 작곡 인력 없이도 브랜드 캠페인이나 콘텐츠에 맞는 맞춤 음악을 빠르게 확보해 제작 비용과 시간을 절감합니다.",
    worstCase: "생성곡의 저작권 보호 범위가 불확실하고 대형 레이블 소송이 진행 중이라, 상업적으로 배포한 음원이 나중에 권리 분쟁이나 수익 회수 리스크에 휘말릴 수 있습니다.",
    verdictBadges: { timeSaver: true, thinkCarefully: true, lockinRisk: true },
  ...
  {
    id: "49900872-c5ef-4ce9-a0e2-71f5dddb49cd",
    name: "Topaz Labs",
    description: "로컬 GPU로 사진과 영상을 고해상도로 복원·업스케일링하는 AI 화질 개선 소프트웨어입니다.",
    problemContexts: ["저해상도 사진·영상 화질이 낮다", "옛날 영상 노이즈 제거가 어렵다", "인쇄용 고해상도 변환이 필요하다"],
    whyExist: "저해상도 아카이브 영상이나 사진을 인쇄·방송·재편집 품질로 복원하려는 사진작가·영상 편집자의 수요에서 출발해, 클라우드 대신 로컬 GPU로 처리하는 전문 업스케일링 소프트웨어로 자리잡았습니다.",
    impact: { judgmentSpeed: 6, thinkingDepth: 4, executionDensity: 8, collaborationClarity: 2 },
    bestCase: "사진작가와 영상 편집자가 고가의 재촬영이나 아카이브 손실 없이 저해상도 자료를 방송·인쇄 품질로 되살려 제작비를 절감합니다.",
    worstCase: "생성형 모델이 원본에 없는 디테일을 만들어내면, 다큐멘터리나 증거 자료처럼 사실 그대로가 중요한 이미지에서 왜곡·조작 논란이 생길 수 있습니다.",
    verdictBadges: { timeSaver: true, thinkCarefully: true, lockinRisk: true },
    alternatives: ["Magnific AI", "Adobe Photoshop", "Upscayl"],
    category: "AI 이미지/영상 업스케일링",
