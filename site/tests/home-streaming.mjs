/**
 * Home RSC streaming regression checks.
 * Run: node --conditions=react-server --test tests/home-streaming.mjs
...
test('Home hero and search shell stream while recent published posts remain pending; post follows release',async()=>{
 ...
 assert.equal(checks.heroBefore,true,'Home hero must stream while the recent-posts D1 read is pending');
